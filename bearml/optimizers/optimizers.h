    ...
    namespace neural_network{
        namespace optimizers {
            ...
            class SGD: public Optimizer{
                ...
                public:
                    SGD(std::vector<std::shared_ptr<bearml::Node<T>>> params, double learning_rate= 0.0001);
                    void step() override;
            ...
            class Adam: public Optimizer{
                ...
                public:
                    Adam(std::vector<std::shared_ptr<bearml::Node<T>>> params, double learning_rate= 0.0001, double beta1 = 0.9, double beta2 = 0.999, double eps = 1e-8);
                    void step() override;
                    void zero_grad() override;
            };
            ...
            template<typename T>
            SGD<T>::SGD(std::vector<std::shared_ptr<bearml::Node<T>>> params, double learning_rate)
            ...
            template<typename T>
            Adam<T>::Adam(std::vector<std::shared_ptr<bearml::Node<T>>> params, double learning_rate, double beta1, double beta2, double eps)
