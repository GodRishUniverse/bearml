...
namespace bearml {
    namespace cuda {
        ...
        #define INSTANTIATE_ELEMENT_WISE(T) \
            template __global__ void bearml::cuda::element_wise_broadcast<T>(const size_t*, const size_t*,  const size_t*, size_t, size_t, const T*, const T*, T*, OP_Code); \
            template __global__ void bearml::cuda::element_wise_contiguous<T>(const T* __restrict__ a,const T* __restrict__ b, T* res, size_t n, OP_Code op_code); \
            template __global__ void bearml::cuda::element_wise_contiguous_with_constant<T>(const T*, const T*, T*, size_t, OP_Code, LHS_RHS_Code); \
            ...
            template __global__ void bearml::cuda::element_wise_unary<T>(const T*, T*, size_t, OP_Code); \
