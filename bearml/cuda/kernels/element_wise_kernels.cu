...
namespace bearml {
    namespace cuda {
        ...
        // // bfloat16
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<__nv_bfloat16 >(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const __nv_bfloat16*  a, const __nv_bfloat16*  b, __nv_bfloat16* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);

        // // float16
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<__half >(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const __half*  a, const __half*  b, __half* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);

        // // float32
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<float >(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const float*  a, const float*  b, float* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);

        // // float64
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<double >(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const double*  a, const double*  b, double* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);

        // // ---------------------------------- Template specification for ints ----------------------------------
        // // int8
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<int8_t>(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const int8_t*  a, const int8_t*  b, int8_t* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);
        // // int16
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<int16_t>(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const int16_t*  a, const int16_t*  b, int16_t* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);
        // // int32
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<int32_t>(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const int32_t*  a, const int32_t*  b, int32_t* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);
        // // int64
        // template __global__ void bearml::cuda::element_wise_broadcast_with_constant<int64_t>(const size_t*  strides_a, const size_t*  res_shape, size_t res_flat_shape, size_t outShapeSize, const int64_t*  a, const int64_t*  b, int64_t* res, OP_Code op_code, LHS_RHS_Code lhs_rhs_code);
        ...
        // ---------------------------------- Template specification for floats ----------------------------------
        // bfloat16
        template __global__ void bearml::cuda::sign_kernel<__nv_bfloat16 >(const __nv_bfloat16*, __nv_bfloat16*, size_t);

        // float16
        template __global__ void bearml::cuda::sign_kernel<__half >(const __half*, __half*, size_t);

        // float32
        template __global__ void bearml::cuda::sign_kernel<float>(const float*, float*, size_t);

        // float64
        template __global__ void bearml::cuda::sign_kernel<double>(const double*, double*, size_t);

        // ---------------------------------- Template specification for ints ----------------------------------
        // int8
        template __global__ void bearml::cuda::sign_kernel<int8_t >(const int8_t*, int8_t*, size_t);
        // int16
        template __global__ void bearml::cuda::sign_kernel<int16_t >(const int16_t*, int16_t*, size_t);
        // int32
        template __global__ void bearml::cuda::sign_kernel<int32_t>(const int32_t*, int32_t*, size_t);
        // int64
        template __global__ void bearml::cuda::sign_kernel<int64_t>(const int64_t*, int64_t*, size_t);
