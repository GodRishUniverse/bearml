...
namespace simplenet {
    namespace utils {
        ...
        static std::vector<int> computeBroadcastShape(const std::vector<int>& A, const std::vector<int>& B)
        {
        ...
        // static std::pair< std::vector<int>, std::pair< std::vector<int>, std::vector<int>>> oldComputeBroadcastShape(
