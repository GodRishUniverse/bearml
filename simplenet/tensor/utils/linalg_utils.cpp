...
// simplenet::linear_algebra is now a set of function templates; the live
// definitions moved to linalg_utils.tpp (included from tensor/Tensor.h once
// Tensor<T> is complete). Function templates are implicitly inline, so this
// translation unit needs no explicit instantiation.
//
// The experimental / learning notes below are kept here VERBATIM as originally
// written - they are notes, not compiled code.
